...
namespace NFC.Platform.BuildingBlocks.Common.Helpers
{
    ...
    {
        public const long DefaultMaxImageSizeBytes = 10 * 1024 * 1024;
        public const long DefaultMaxExcelSizeBytes = 50 * 1024 * 1024;
        public const long DefaultMaxPdfSizeBytes = 50 * 1024 * 1024;
        ...
        private static readonly byte[] RiffMagicBytes = [0x52, 0x49, 0x46, 0x46];
        private static readonly byte[] WebpMagicBytes = [0x57, 0x45, 0x42, 0x50];

        private static readonly byte[] XlsxMagicBytes = [0x50, 0x4B, 0x03, 0x04];
        private static readonly byte[] XlsMagicBytes = [0xD0, 0xCF, 0x11, 0xE0, 0xA1, 0xB1, 0x1A, 0xE1];
