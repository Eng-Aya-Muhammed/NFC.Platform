...
namespace NFC.Platform.Tests.Controllers
{
    public class CardOrderGapsFixesTests
    {
        ...
        public async Task CreateAsync_ShouldReturn422_WhenValidationFails()
        {
            ...
            var service = new CardOrderService(unitOfWork, mapper, messageService, currentTenant, cardPricingService, validator, backgroundJobClient, Substitute.For<IEmployeeService>(), otpSettingsOptions);
