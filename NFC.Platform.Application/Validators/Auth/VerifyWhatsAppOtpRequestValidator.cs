...
{
    public class VerifyWhatsAppOtpRequestValidator : AbstractValidator<VerifyWhatsAppOtpRequest>
    {
        public VerifyWhatsAppOtpRequestValidator(IMessageService messageService)
        {
            RuleFor(x => x.Email)
                .NotEmpty()
