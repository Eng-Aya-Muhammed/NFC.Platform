...
{
    public class ResendWhatsAppOtpRequestValidator : AbstractValidator<ResendWhatsAppOtpRequest>
    {
        public ResendWhatsAppOtpRequestValidator(IMessageService messageService)
        {
            RuleFor(x => x.Email)
                .NotEmpty()
