...
namespace NFC.Platform.Application.Interfaces.Services
{
    ...
    public interface IAnalyticsService
    {
        ...
        /// </summary>
        Task<ServiceResult<UserAnalyticsSummaryDto>> GetUserAnalyticsSummaryAsync();

        /// <summary>
        /// Returns time-series interaction data for chart rendering.
        /// Granularity: "daily" (last 30 days) or "monthly" (last 6 months).
        /// </summary>
        Task<ServiceResult<UserAnalyticsTimeSeriesDto>> GetUserAnalyticsTimeSeriesAsync(string granularity);

        /// <summary>
        /// Returns an employee leaderboard ranked by total profile interactions
        /// across the current company tenant.
        /// </summary>
        Task<ServiceResult<List<EmployeeLeaderboardEntryDto>>> GetCompanyLeaderboardAsync();
    }
}
